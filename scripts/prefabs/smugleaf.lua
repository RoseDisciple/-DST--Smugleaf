...
local assets = {
        ...
        Asset( "ANIM", "anim/smugleaf.zip" ),
        Asset( "ANIM", "anim/ghost_smugleaf_build.zip" ),
}
local prefabs = {}
...
local common_postinit = function(inst) 
	-- Minimap icon
	inst.MiniMapEntity:SetIcon( "smugleaf.tex" )
end
...
return MakePlayerCharacter("smugleaf", prefabs, assets, common_postinit, master_postinit, start_inv)
